    ...
    <div className="min-h-screen p-6 bg-gray-50">
      ...
      <div className="flex items-center justify-between bg-white p-4 shadow-md rounded-lg">
        ...
        <div className="flex gap-6 text-gray-600">
          <div className="cursor-pointer hover:text-gray-900">Home</div>
          <div className="cursor-pointer hover:text-gray-900">Contact</div>
          <div className="cursor-pointer hover:text-gray-900">About</div>
          <div className="cursor-pointer hover:text-gray-900">Sign Up</div>
        </div>
        <input
          type="search"
          placeholder="Search..."
          className="border p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400"
        />
        <div className="flex gap-4 text-gray-600">
          <Heart size={24} className="cursor-pointer hover:text-gray-900" />
          <ShoppingCart size={24} className="cursor-pointer hover:text-gray-900" />
          <User size={24} className="cursor-pointer hover:text-gray-900" />
        </div>
      </div>
